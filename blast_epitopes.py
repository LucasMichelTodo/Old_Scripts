...
def blast_epitopes(epitope_fasta):
    ...
    cmd = ("blastp -query {} " +
            ...
            "> /home/lucas/ISGlobal/Cruzi/tcruzi_epitopes_vaccine/Microbiome/New_run_091018/blast_{}.xml") .format(epitope_fasta.replace("./", ""),name)

    #print cmd
    subprocess.call(cmd, shell=True)

    result_handle = open("/home/lucas/ISGlobal/Cruzi/tcruzi_epitopes_vaccine/Microbiome/New_run_091018/blast_{}.xml" .format(name))
    ...
    try:
        ...
        with open("/home/lucas/ISGlobal/Cruzi/tcruzi_epitopes_vaccine/Microbiome/New_run_091018/tcd8_microbiome.csv", "a+") as outfile:
