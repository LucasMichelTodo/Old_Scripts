...
with open("/home/lucas/ISGlobal/Cruzi/tcruzi_epitopes_vaccine/Gen_referencies/tcd4_list.txt", "r+") as file:
	for line in file:
...
with open("Results_tcd4.txt", "w+") as file:
...
def check_epitopes(fasta_file):
	...
	for epitope in epitopes_t:
		...
		if result:
			...
			print "\n"+"-----------------------------------------------------------------"+"\n"
			with open("Results_tcd4.txt", "a+") as file:
