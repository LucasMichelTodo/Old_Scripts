...
norm_in <- as.data.frame(cbind(total_10G_in, total_1.2B_in, total_A7_in, total_E5_in))
norm_in["total"] <- apply(norm_in, 1, mean)
...
p + geom_line() +
    labs(title = "AP2G Coverage Acetilació/Metilació", x = "Position", y = "Coverage (Acetilation)", colour = "Strain") +
    theme(plot.title = element_text(hjust = 0.5)) +
    geom_vline(xintercept =907203, linetype="dotted") +
    geom_vline(xintercept =914501, linetype="dotted")
@
...
p <- ggplot(df_acmet_m, aes(x = pos, y = df_acmet_m$value, colour = df_acmet_m$variable))
p + geom_line() +
    labs(title = "AP2G Coverage Metilació/Acetilació", x = "Position", y = "Coverage (Acetilation)", colour = "Strain") +
    theme(plot.title = element_text(hjust = 0.5)) +
    geom_vline(xintercept =907203, linetype="dotted") +
    geom_vline(xintercept =914501, linetype="dotted")
@
