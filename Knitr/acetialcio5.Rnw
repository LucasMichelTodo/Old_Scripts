...
df2 <- cov_12B[cov_12B$difexp != "FALSE" & cov_12B$Type == "ORF",]
table(df$Variant)
df["Class"] <- "Regular"
df2["Class"] <- "Regular"
df[df$Variant == TRUE & df$difexp =="UP",]$Class <- "Variant-Active"
df[df$Variant == TRUE & df$difexp =="DOWN",]$Class <- "Variant-Inactive"
df2[df2$Variant == TRUE & df2$difexp =="UP",]$Class <- "Variant-Active"
df2[df2$Variant == TRUE & df2$difexp =="DOWN",]$Class <- "Variant-Inactive"
