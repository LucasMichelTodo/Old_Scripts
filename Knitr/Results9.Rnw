...
### Importar gens amb duplicacions/delecions
...
dupl_del <- input_diff[abs(input_diff$Gene.cov) > 1.5,]$gene[1:9]

Trans <- Trans[!Trans$ID %in% dupl_del,]
...
df_10G <- df_10G[!df_10G$Gene %in% dupl_del,]
df_1.2B <- df_1.2B[!df_1.2B$Gene %in% dupl_del,]
...
#write.table(Trans2, "/home/lucas/ISGlobal/Chip_Seq/Transcripció_CSV/Trans2.csv", sep="\t", row.names = FALSE)
...
cov_10G <- cov_10G[!cov_10G$Gene %in% dupl_del,]
cov_1.2B <- cov_1.2B[!cov_1.2B$Gene %in% dupl_del,]
...
multi_10G <- multi_10G[!multi_10G$Gene %in% dupl_del,]
multi_1.2B <- multi_1.2B[!multi_1.2B$Gene %in% dupl_del,]
...
ac_10G <- ac_10G[!ac_10G$Gene %in% dupl_del,]
ac_1.2B <- ac_1.2B[!ac_1.2B$Gene %in% dupl_del,]
...
dif_10G_cov <- dif_10G_cov[!dif_10G_cov$Gene %in% dupl_del,]
dif_1.2B_cov <- dif_1.2B_cov[!dif_1.2B_cov$Gene %in% dupl_del,]
...
<<percentatge_nou, warning=FALSE, fig.align='center', out.width="20cm", out.height="13cm", echo = FALSE>>=
...
\clearpage
\subsection{Coverage}
<<trans_cov, warning=FALSE, fig.align='center', out.width="20cm", out.height="13cm", echo = FALSE>>=
...
## Met df
hm_met_m <- melt(heatmap_df[,c(2:4,8)], id ="id")

## Ac df
hm_ac_m <- melt(heatmap_df[,c(5:7,8)], id ="id")

## Plots
plot_ac <- ggplot(hm_ac_m, aes(x = variable, y = id, fill = value)) + 
  geom_tile() + 
  scale_fill_gradient2(low = "red", high = "green", mid = "black") +
  scale_x_discrete(expand = c(0, 0)) + scale_y_discrete(expand = c(0,0), position = "right") +
  labs(x=NULL, y=NULL, title="") +
  ...
  theme(axis.line.y = element_blank(), axis.line.x = element_blank(), axis.ticks=element_blank()) +
  theme(legend.position="bottom", legend.justification="left") +
  theme(legend.key.width = unit(1.3,"line"),  legend.title = element_blank(), legend.text = element_text(size = 6)) +
  theme(axis.text.x = element_text(angle=-90, hjust=0, size = 8))

plot_met <- ggplot(hm_met_m, aes(x = variable, y = id, fill = value)) + 
  geom_tile() + 
  scale_fill_gradient2(low = "red", high = "green", mid = "black") +
  scale_x_discrete(expand = c(0, 0)) + scale_y_discrete(expand = c(0,0)) +
  labs(x=NULL, y=NULL, title="") +
...
plot_trans <- ggplot(hm_trans_m, aes(x = variable, y = id, fill = value)) + 
  ...
  scale_fill_gradient2(low = "red", high = "green", mid = "black") +
  scale_x_discrete(expand = c(0, 0)) + scale_y_discrete(expand = c(0,0)) +
  labs(x=NULL, y=NULL, title="Coverage") +
  theme(plot.title=element_text(hjust=0)) +
  theme(axis.text.y = element_blank(), axis.line.y = element_blank(), axis.line.x = element_blank(), axis.ticks=element_blank()) +
  theme(legend.position="bottom", legend.justification="left") +
  theme(legend.key.width = unit(0.35,"line"), legend.title = element_blank(), legend.text = element_text(size = 6)) +
  theme(axis.text.x = element_text(angle=-90, hjust=0, size = 8))

plot_grid(plot_trans, plot_met, plot_ac, align = "h", rel_widths = c(0.1, 0.3, 0.85), ncol = 3)
@
\clearpage
\subsection{Coverage en Pics}
Aquest gràfic agafar amb pinces! (potser s'hauria de fer per separa 5'/ORF/3')
<<trans_covapics, warning=FALSE, fig.align='center', out.width="20cm", out.height="13cm", echo = FALSE>>=
...
neg <- heatmap_df[,1:4] < 0  ### Aplicar escala logarítmica (primer fem abs i després *-1 als negatius)
heatmap_df[,1:4] <- log2(abs(heatmap_df[,1:4])+1)
heatmap_df[,1:4][neg] <- heatmap_df[,1:4][neg]*-1
...
plot_trans <- ggplot(hm_trans_m, aes(x = variable, y = id, fill = value)) + 
  ...
  scale_fill_gradient2(low = "red", high = "green", mid = "black") +
  scale_x_discrete(expand = c(0, 0)) + scale_y_discrete(expand = c(0,0)) +
  labs(x=NULL, y=NULL, title="Coverage (log2 scale) a pics diferencials") +
  theme(plot.title=element_text(hjust=0)) +
  theme(axis.text.y = element_blank(), axis.line.y = element_blank(), axis.line.x = element_blank(), axis.ticks=element_blank()) +
  theme(legend.position="bottom", legend.justification="left") +
  theme(legend.key.width = unit(0.75,"line"), legend.title = element_blank(), legend.text = element_text(size = 6))
...
<<met_percet_5, warning=FALSE, fig.align='center', out.width="20cm", out.height="12.5cm", echo = FALSE>>=
...
plot_met <- ggplot(heatmap_df_m, aes(x = variable, y = id, fill = value)) + 
  ...
  theme(axis.line.y = element_blank(), axis.line.x = element_blank(), axis.ticks=element_blank()) +
  theme(legend.position="bottom", legend.justification="left") +
  theme(legend.key.width = unit(1,"line"),  legend.title = element_blank(), legend.text = element_text(size = 6))
...
plot_grid(plot_trans, plot_met, align = "h", rel_widths = c(0.1, 0.375))
@
\clearpage
\subsubsection{Percentatge de gen covert ORF}
<<met_percet_ORF, warning=FALSE, fig.align='center', out.width="20cm", out.height="12.5cm", echo = FALSE>>=
...
<<met_percet_3, warning=FALSE, fig.align='center', out.width="20cm", out.height="12.5cm", echo = FALSE>>=
...
plot_grid(plot_trans, plot_met, align = "h", rel_widths = c(0.1, 0.275))
@
\clearpage

\subsection{Coverage}
\subsubsection{Coverage 5}
<<met_cov_5, warning=FALSE, fig.align='center', out.width="20cm", out.height="13cm", echo = FALSE>>=
diff <- (as.numeric(cov_1.2B$X5.cov) - as.numeric(cov_10G$X5.cov))
diff_ac <- (as.numeric(ac_1.2B$X5.cov) - as.numeric(ac_10G$X5.cov))
heatmap_df <- data.frame(cov_1.2B$Gene, diff, diff_ac)
...
colnames(heatmap_df) <- c("ID","Met", "Ac", "Trans")
heatmap_df <- heatmap_df[,c(4,2,3)]
df_cov_5 <- heatmap_df
...
## Met df
hm_met <- as.data.frame(heatmap_df[,2])
hm_met["id"] <- rownames(heatmap_df)
hm_met$id <- factor(hm_met$id, levels=unique(as.character(hm_met$id)))
colnames(hm_met)[1] <- "Met"

hm_met_m <- melt(hm_met, id ="id")

## Ac df
hm_ac <- as.data.frame(heatmap_df[,3])
hm_ac["id"] <- rownames(heatmap_df)
hm_ac$id <- factor(hm_ac$id, levels=unique(as.character(hm_ac$id)))
colnames(hm_ac)[1] <- "Ac"

hm_ac_m <- melt(hm_ac, id ="id")
...
plot_ac <- ggplot(hm_ac_m, aes(x = variable, y = id, fill = value)) + 
  ...
  theme(axis.line.y = element_blank(), axis.line.x = element_blank(), axis.ticks=element_blank()) +
  theme(legend.position="bottom", legend.justification="left") +
  theme(legend.key.width = unit(0.6,"line"),  legend.title = element_blank(), legend.text = element_text(size = 6)) +
  theme(axis.text.x = element_text(angle=-90, hjust=0, size = 8))
...
plot_grid(plot_trans, plot_met, plot_ac, align = "h", rel_widths = c(0.1, 0.1, 0.5), ncol = 3)
@
\clearpage
\subsubsection{Coverage ORF}
<<met_cov_ORF, warning=FALSE, fig.align='center', out.width="20cm", out.height="13cm", echo = FALSE>>=
diff <- (as.numeric(cov_1.2B$Gene.cov) - as.numeric(cov_10G$Gene.cov))
diff_ac <- (as.numeric(ac_1.2B$Gene.cov) - as.numeric(ac_10G$Gene.cov))
heatmap_df <- data.frame(cov_1.2B$Gene, diff, diff_ac)
heatmap_df <- heatmap_df[heatmap_df$cov_1.2B.Gene %in% met_genes,]
heatmap_df["Trans"] <- apply(heatmap_df, 1, function(x) Trans[Trans$ID == x[1],]$`Dif_1.2-10`[1])
heatmap_df <- arrange(heatmap_df, diff)
...
<<met_cov_3, warning=FALSE, fig.align='center', out.width="20cm", out.height="13cm", echo = FALSE>>=
diff <- (as.numeric(cov_1.2B$X3.cov) - as.numeric(cov_10G$X3.cov))
diff_ac <- (as.numeric(ac_1.2B$X3.cov) - as.numeric(ac_10G$X3.cov))
heatmap_df <- data.frame(cov_1.2B$Gene, diff, diff_ac)
heatmap_df <- heatmap_df[heatmap_df$cov_1.2B.Gene %in% met_genes,]
heatmap_df["Trans"] <- apply(heatmap_df, 1, function(x) Trans[Trans$ID == x[1],]$`Dif_1.2-10`[1])
heatmap_df <- arrange(heatmap_df, diff)
...
<<met_covapics_5, warning=FALSE, fig.align='center', out.width="20cm", out.height="12.5cm", echo = FALSE>>=
...
plot_trans <- ggplot(hm_trans_m, aes(x = variable, y = id, fill = value)) + 
  ...
  scale_fill_gradient2(low = "red", high = "green", mid = "black") +
  scale_x_discrete(expand = c(0, 0)) + scale_y_discrete(expand = c(0,0)) +
  labs(x=NULL, y=NULL, title="Coverage a pics") +
  theme(plot.title=element_text(hjust=0)) +
  theme(axis.text.y = element_blank(), axis.line.y = element_blank(), axis.line.x = element_blank(), axis.ticks=element_blank()) +
  theme(legend.position="bottom", legend.justification="left") +
  theme(legend.key.width = unit(1,"line"), legend.title = element_blank(), legend.text = element_text(size = 6))
...
<<met_covapics_ORF, warning=FALSE, fig.align='center', out.width="20cm", out.height="12.5cm", echo = FALSE>>=
...
<<met_covapics_3, warning=FALSE, fig.align='center', out.width="20cm", out.height="12.5cm", echo = FALSE>>=
...
\clearpage
\subsection{Gràfics}
<<cor_plots1, warning=FALSE, fig.align='center', out.width="20cm", out.height="12cm", echo = FALSE>>=
hist(met_df$Met_5, breaks = 10)
@
\clearpage
<<cor_plots2, warning=FALSE, fig.align='center', out.width="20cm", out.height="12cm", echo = FALSE>>=
hist(cov_10G$X5.cov, breaks = 2000, xlim = c(1,15))
@
\clearpage
<<cor_plots3, warning=FALSE, fig.align='center', out.width="20cm", out.height="12cm", echo = FALSE>>=
