...
# 	# # SortSam
# 	# print "----------------Sorting SAMs----------------"
# 	# cmd = "java -jar $PICARD SortSam INPUT=/home/lucas/ISGlobal/Chip_Seq/DATA/Aligns/q5/{}_in_sort_q5.bam \
# 	# 								OUTPUT={}_GATKsorted.bam SO=coordinate VALIDATION_STRINGENCY=LENIENT CREATE_INDEX=true" .format(sample, sample)
...
# 	# sp.Popen(cmd, shell=True).wait()
# 	# print cmdcmd = "java -jar $GATK -T RealignerTargetCreator -R ref.fasta -I {}_GATKsorted_dupl_aorg.bam -o {}_GATKsorted_dupl_aorg.bam.list" .format(sample, sample)
# 	# sp.Popen(cmd, shell=True).wait()
# 	# print cmd
#     #
# 	# #IndelRealigner
