...
# Set in/out paths
inpath = "/home/lucas/ISGlobal/TestSet/align_tests2/inputs/" 
outpath = "/home/lucas/ISGlobal/TestSet/align_tests2/"

# Set params
params = {"params_1":"-p 1 --very-sensitive --local -5 4 -3 4 -I 50 -X 250", 
		"params_2":"-p 1 --very-sensitive --local -5 4 -3 4 -I 50 -X 10000",
		"params_3":"-p 1 --very-sensitive --local -5 12 -3 4 -I 50 -X 10000",
		"params_4":"-p 1 --very-sensitive --local -N 1 -5 12 -3 4 -I 50 -X 10000"}
