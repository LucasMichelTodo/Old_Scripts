...
# Set in/out paths
inpath = "/home/lucas/ISGlobal/Chip_Seq/HiSeq_run_CRG_ChIP2_040816_zips/" 
outpath = "/home/lucas/ISGlobal/TestSet/align_tests/Inputs_tests/"

# Set params
params = {"params_1":"-p 1 --very-sensitive --local -5 4 -3 4 -I 50 -X 250", 
		"params_2":"-p 1 --very-sensitive --local -5 4 -3 4 -I 50 -X 2000",
		"params_3":"-p 1 --very-sensitive --local -5 12 -3 4 -I 50 -X 2000"}
...
for key in params:
	...
	for x in tqdm(names):
		cmd = "~/Programs/bowtie2-2.3.0-legacy/bowtie2 {} -x ~/Programs/bowtie2-2.3.0-legacy/Pf3D7 -1 {} -2 {} > {}"\
		 .format(params[key], inpath+x+"_read1.fastq", inpath+x+"_read2.fastq", outpath+key+"/"+x+".sam")
